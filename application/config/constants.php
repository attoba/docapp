...
defined('EXIT_AUTO_MIN')      || define('EXIT_AUTO_MIN', 9); // lowest automatically-assigned err|| code
defined('EXIT_AUTO_MAX')      || define('EXIT_AUTO_MAX', 125); // highest automatically-assigned err|| code
